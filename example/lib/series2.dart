...
class SeriesPage2 extends StatefulWidget {
  SeriesPage2({Key key, this.score,this.name,this.qColumns,this.subjectCode,this.tcode,this.stdId}) : super (key : key);
...
class _SeriesPage1State extends State<SeriesPage2> {
      ...
      child: Column(
        children: <Widget>[
          ...
          new RaisedButton(
            ...
            child: Text('บันทึก'),
            onPressed: () {
              sendScore(WirteScoreController.text);
            },
          )
        ],
      ),
